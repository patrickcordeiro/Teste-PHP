...
class DataRequest
{
    ...
    /**
     * Função que retorna as categorias e suas opções do menu ou a quantidade de de categorias
     * @param string recebe 'c' ou vazio
     * @return array||String
     */
    ...
    /**
     * Função que retorna os dados respectivos de acordo com o tipo desejado: usuarios, categoria ou clientes.
     * @param string recebe 'c' ou vazio
     * @return array||String
     */
...
echo json_encode($DataRequest->returnTable($type));
